...
// One-time self-heal: older AI-created projects/tasks were stored under the
// literal "guest" owner (pre-fix). Whoever loads the app claims them with
// their own id so they become editable again.
...
router.put("/:id", async (req, res, next) => {
  try {
    ...
    const project = await Project.findOneAndUpdate(
      { _id: req.params.id, ownerId: ownerOf(req) },
      update,
